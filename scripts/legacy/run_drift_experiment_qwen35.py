...
"""Run system prompt ablation on Qwen3.5 models via vLLM.
...
Usage:
    nohup uv run python -u scripts/run_drift_experiment_qwen35.py \
        > results/drift_experiment_qwen35/<model>/run.log 2>&1 &
"""
...
def sanitize_model_name(name: str) -> str:
    """Convert model name to a filesystem-safe string (e.g., 'qwen3.5:35b' → 'qwen3_5_35b')."""
...
def main() -> None:
    ...
    out_dir = Path(f"results/drift_experiment_qwen35/{safe_name}")
