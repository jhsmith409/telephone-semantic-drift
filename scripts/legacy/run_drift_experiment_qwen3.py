...
"""Run 30-iteration drift experiment for Qwen3 family across sizes and quantizations.

Tests 20 models: 6 parameter sizes (0.6b, 1.7b, 4b, 8b, 30b, 32b) × 3 quant levels
(fp16, q8_0, q4_K_M), plus 30b thinking variants and qwen3-next:80b.

Usage:
    nohup uv run python -u scripts/run_drift_experiment_qwen3.py &
"""
...
def plot_results(all_data: dict) -> None:
    ...
    ax.set_title(
        "Qwen3 Semantic Drift: Size × Quantization (paraphrase, t=0.7)\n"
        "20 Models — 30 Iterations",
        fontsize=13,
    )
