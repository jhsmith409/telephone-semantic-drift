...
changing what the model produces when it does answer. The stack differences
Paper~A reported are best read as differences in default samplers between
deployments that had reasoning enabled.
