...
information that practitioners care about. Across 2{,}662 completed chains
and 85{,}460 model calls on eight configurations served by vLLM, SGLang and
llama.cpp, we find:
...
runaway-thinking failure of the previous generation at a low rate;
...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Breadth}: the sixteen domain prompts with thinking off on
        ...
        prompt (host A, 5).
\end{enumerate}
In total 2{,}662 chains and 85{,}460 model calls completed with no API
...
\paragraph{Scale.}
2{,}662 chains, 85{,}460 model calls, run between 6 and 7 September 2026;
